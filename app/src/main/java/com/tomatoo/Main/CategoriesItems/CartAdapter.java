...
public class CartAdapter extends RecyclerView.Adapter<CartAdapter.ViewHolder> {
    ...
    private RecyclerItemClickListner cartItemClickListner;
    ...
    public void setOnCartItemClickListener(RecyclerItemClickListner listener) {
            ...
            plus_img.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION) {
                        ...
                        ShoppingCartActivity.total += cartItemModel.getPrice();
                        ShoppingCartActivity.total_cart_val += cartItemModel.getPrice();
                        ShoppingCartActivity.items_price.setText(String.valueOf(ShoppingCartActivity.total));
                        ShoppingCartActivity.items_price.append("$");
                        ShoppingCartActivity.total_cart_price_txtV.setText(String.valueOf(ShoppingCartActivity.total_cart_val));
                        ShoppingCartActivity.total_cart_price_txtV.append("$");
                    }
                }
            });
