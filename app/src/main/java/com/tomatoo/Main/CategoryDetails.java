    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView.addOnScrollListener(new EndlessRecyclerViewScrollListener(gridLayoutManager) {
            ...
            public void onLoadMore(int page, int totalItemsCount, RecyclerView view) {
                if (cat_prod) {
                    ...
                    Log.v(TAG,"lllllist"+sub_CategorylList.get(subCat_position).getCategory_id());
                }
            }
        });
        ...
        products_adapter.setOnItemClickListener(new RecyclerOnItemClickListner() {
            ...
            public void OnItemClick(int position) {
                Intent intent = new Intent(CategoryDetails.this, ItemDetailsActivity.class);
            ...
            public void OnCartClick(int position, ImageView cart_image) {
                if (productslList.get(position).getCart() == 0) {
                    dealingWithCartItem.addTocart(CategoryDetails.this, productslList.get(position), progressBar, cart_image, productslList.get(position).getProduct_id(), MainPageActivity.userData.getId(), 1, MainPageActivity.userData.getToken());
                } else {
                    dealingWithCartItem.removeFromCart(CategoryDetails.this, productslList.get(position), progressBar, cart_image, productslList.get(position).getProduct_id(), dealingWithCartItem.Cart_id, MainPageActivity.userData.getToken());
                }
            }
