...
public class OrderDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent().hasExtra("order_data")) {
            ...
            Log.i("use_id:: ", MainPageActivity.userData.getId() + "");
    ...
    private void getOrderDetails(final int order_id) {
        final ProgressDialog dialog = dialogUtil.showProgressDialog(OrderDetails.this, getString(R.string.loading), false);
        ApiServiceInterface serviceInterface = ApiClient.getClient().create(ApiServiceInterface.class);
        Call<OrderDetailsModel> call = serviceInterface.getOrderDetails(MainPageActivity.userData.getId(), MainPageActivity.userData.getToken(), order_id);
            ...
            public void onResponse(Call<OrderDetailsModel> call, Response<OrderDetailsModel> response) {
                ...
                if (detailsModel.getStatus()) {
                    ...
                    if (order_info.getOrder_Status().equals("processing")) {
                        ...
                        state_imageV.setImageResource(R.drawable.onway_icon_details);
