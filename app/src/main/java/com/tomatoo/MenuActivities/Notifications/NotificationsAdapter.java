...
public class NotificationsAdapter extends RecyclerView.Adapter<NotificationsAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView orderNum_txtV, time_ago_txtV;
//        public LinearLayout view_back_ground;
//        public ConstraintLayout view_foreground;

        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            orderNum_txtV = itemView.findViewById(R.id.message_title_txtV);
//            orderProcess_txtV = itemView.findViewById(R.id.orderProcess_txtV_id);
            time_ago_txtV = itemView.findViewById(R.id.message_desc_txtV);
